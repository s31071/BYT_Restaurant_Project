...
public class ReceiptTest {
    ...
    void setup() {
        ...
        receiptWithTip = new Receipt(PaymentMethod.CARD, order100, 10.0);
    }
    ...
    @Test
    void testGetSumWithoutTip() {
        Receipt r = new Receipt(PaymentMethod.CARD, order100, null);
        double expected = 100 + (100 * Receipt.service);
        assertEquals(expected, r.getSum());
    }

    @Test
    void testGetSumWithTip() {
        Receipt r = new Receipt(PaymentMethod.CARD, order100, 15.0);
    ...
    void testConstructorNullPaymentMethodThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Receipt(null, order));
    }
}